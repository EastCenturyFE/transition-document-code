...
export default {
  ...
  methods: {
    ...
    calcCircleBEState () {
      const { animationAreaOriginPos: [bx], canvasWH: [w], centerPos: [, y] } = this
    ...
    calcAnimationFrameData () {
      ...
      this.animationFrameData = transition(data, circleBeginState, circleEndState, animationFrameNum)
    },
    drawAnimation () {
    ...
    drawGrid () {
      const { ctx, animationLength, animationAreaOriginPos: [x, y], canvasWH: [w, h], areaLineColor } = this
